...
/obj/item/weapon/reagent_containers/food/snacks/sliceable/pizza/macpizza
	name = "Macaroni cheese pizza"
	desc = "Gastronomists have yet to classify this dish as 'pizza'."
	icon_state = "macpizza"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/macpizzaslice
	list_reagents = list("nutriment" = 40, "vitamin" = 5) //More nutriment because carbs, but it's not any more vitaminicious
	filling_color = "#ffe45d"

/obj/item/weapon/reagent_containers/food/snacks/macpizzaslice
